...
const departmentOptions = [
  'Engineering', 'Product', 'Design', 'Marketing', 'Finance', 'Operations', 'Sales'
];
...
const AddInterviewer = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccessMsg('Interviewer account created successfully!');
      setTimeout(() => {
        navigate('/admin');
      }, 2000);
    } catch (err) {
      const msg = err.response?.data?.message || 'Failed to create interviewer account';
        ...
        <Paper elevation={0} sx={{
          ...
          <Box sx={{ px: 5, pt: 5, pb: 4 }}>
            ...
            <Typography sx={{ color: '#64748b', fontSize: '0.9rem', mt: 0.75 }}>
              Complete the information below to add a new interviewer to your team.
            </Typography>
          </Box>
          ...
          <Box sx={{ px: 5, pb: 5 }}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2.5, mb: 4 }}>
              ...
              />
              <TextField
                label="Last Name" placeholder="e.g. Wilson"
              ...
              />
              <TextField
                label="Email Address" placeholder="jane.wilson@company.com" type="email"
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              ...
              >
                {loading ? <CircularProgress size={20} sx={{ color: 'white' }} /> : 'Create Interviewer Account'}
              </Button>
            </Box>
          </Box>
        </Paper>
